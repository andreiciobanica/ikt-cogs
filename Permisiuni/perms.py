...
class permisiuni(commands.Cog):
    ...
    async def permisiuni(self, ctx):
        ...
        for x in permisiuni.imbracaminte:
            ...
            perms_muted = discord.Permissions(view_channel=False, manage_channels=False, manage_permissions=False, manage_webhooks=False, create_instant_invite=None, send_messages=False, embed_links=None, attach_files=None, add_reactions=None, use_external_emojis=None, mention_everyone=None, manage_messages=False, read_message_history=True, send_tts_messages=False, use_slash_commands=None)
            perms_everyone = discord.Permissions(view_channel=False, manage_channels=False, manage_permissions=False, manage_webhooks=False, create_instant_invite=None, send_messages=False, embed_links=None, attach_files=None, add_reactions=None, use_external_emojis=None, mention_everyone=None, manage_messages=False, read_message_history=True, send_tts_messages=False, use_slash_commands=None)
            await c.set_permissions(ctx.guild.get_role(manager), permissions=perms_manager)
            await c.set_permissions(ctx.guild.get_role(permisiuni.lideri[permisiuni.imbracaminte.index(x)]), permissions=perms_lider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.colideri[permisiuni.imbracaminte.index(x)]), permissions=perms_colider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.tester[permisiuni.imbracaminte.index(x)]), permissions=perms_tester)
            await c.set_permissions(ctx.guild.get_role(permisiuni.membru[permisiuni.imbracaminte.index(x)]), permissions=perms_membru)
            await c.set_permissions(ctx.guild.get_role(permisiuni.mafia[permisiuni.imbracaminte.index(x)]), permissions=perms_mafia)
            await c.set_permissions(ctx.guild.get_role(civil), permissions=perms_civil)
            await c.set_permissions(ctx.guild.get_role(muted), permissions=perms_muted)
            await c.set_permissions(everyone, permissions=perms_everyone)
        ...
        for x in permisiuni.anunturi:
            ...
            perms_everyone = discord.Permissions(view_channel=False, manage_channels=False, manage_permissions=False, manage_webhooks=False, create_instant_invite=None, send_messages=False, embed_links=None, attach_files=None, add_reactions=None, use_external_emojis=None, mention_everyone=None, manage_messages=False, read_message_history=True, send_tts_messages=False, use_slash_commands=None)
            await c.set_permissions(ctx.guild.get_role(manager), permissions=perms_manager)
            await c.set_permissions(ctx.guild.get_role(permisiuni.lideri[permisiuni.anunturi.index(x)]), permissions=perms_lider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.colideri[permisiuni.anunturi.index(x)]), permissions=perms_colider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.tester[permisiuni.anunturi.index(x)]), permissions=perms_tester)
            await c.set_permissions(ctx.guild.get_role(permisiuni.membru[permisiuni.anunturi.index(x)]), permissions=perms_membru)
            await c.set_permissions(ctx.guild.get_role(permisiuni.mafia[permisiuni.anunturi.index(x)]), permissions=perms_mafia)
            await c.set_permissions(ctx.guild.get_role(civil), permissions=perms_civil)
            await c.set_permissions(ctx.guild.get_role(muted), permissions=perms_muted)
            await c.set_permissions(everyone, permissions=perms_everyone)
        ...
        for x in permisiuni.chat:
            ...
            perms_everyone = discord.Permissions(view_channel=False, manage_channels=False, manage_permissions=False, manage_webhooks=False, create_instant_invite=None, send_messages=False, embed_links=None, attach_files=None, add_reactions=None, use_external_emojis=None, mention_everyone=None, manage_messages=False, read_message_history=True, send_tts_messages=False, use_slash_commands=None)
            await c.set_permissions(ctx.guild.get_role(manager), permissions=perms_manager)
            await c.set_permissions(ctx.guild.get_role(permisiuni.lideri[permisiuni.chat.index(x)]), permissions=perms_lider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.colideri[permisiuni.chat.index(x)]), permissions=perms_colider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.tester[permisiuni.chat.index(x)]), permissions=perms_tester)
            await c.set_permissions(ctx.guild.get_role(permisiuni.membru[permisiuni.chat.index(x)]), permissions=perms_membru)
            await c.set_permissions(ctx.guild.get_role(permisiuni.mafia[permisiuni.chat.index(x)]), permissions=perms_mafia)
            await c.set_permissions(ctx.guild.get_role(civil), permissions=perms_civil)
            await c.set_permissions(ctx.guild.get_role(muted), permissions=perms_muted)
            await c.set_permissions(everyone, permissions=perms_everyone)
        ...
        for x in permisiuni.taxe:
            ...
            perms_everyone = discord.Permissions(view_channel=False, manage_channels=False, manage_permissions=False, manage_webhooks=False, create_instant_invite=None, send_messages=False, embed_links=None, attach_files=None, add_reactions=None, use_external_emojis=None, mention_everyone=None, manage_messages=False, read_message_history=True, send_tts_messages=False, use_slash_commands=None)
            await c.set_permissions(ctx.guild.get_role(manager), permissions=perms_manager)
            await c.set_permissions(ctx.guild.get_role(permisiuni.lideri[permisiuni.taxe.index(x)]), permissions=perms_lider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.colideri[permisiuni.taxe.index(x)]), permissions=perms_colider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.tester[permisiuni.taxe.index(x)]), permissions=perms_tester)
            await c.set_permissions(ctx.guild.get_role(permisiuni.membru[permisiuni.taxe.index(x)]), permissions=perms_membru)
            await c.set_permissions(ctx.guild.get_role(permisiuni.mafia[permisiuni.taxe.index(x)]), permissions=perms_mafia)
            await c.set_permissions(ctx.guild.get_role(civil), permissions=perms_civil)
            await c.set_permissions(ctx.guild.get_role(muted), permissions=perms_muted)
            await c.set_permissions(everyone, permissions=perms_everyone)
        ...
        for x in permisiuni.dovada:
            ...
            perms_everyone = discord.Permissions(view_channel=False, manage_channels=False, manage_permissions=False, manage_webhooks=False, create_instant_invite=None, send_messages=False, embed_links=None, attach_files=None, add_reactions=None, use_external_emojis=None, mention_everyone=None, manage_messages=False, read_message_history=True, send_tts_messages=False, use_slash_commands=None)
            await c.set_permissions(ctx.guild.get_role(manager), permissions=perms_manager)
            await c.set_permissions(ctx.guild.get_role(permisiuni.lideri[permisiuni.dovada.index(x)]), permissions=perms_lider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.colideri[permisiuni.dovada.index(x)]), permissions=perms_colider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.tester[permisiuni.dovada.index(x)]), permissions=perms_tester)
            await c.set_permissions(ctx.guild.get_role(permisiuni.membru[permisiuni.dovada.index(x)]), permissions=perms_membru)
            await c.set_permissions(ctx.guild.get_role(permisiuni.mafia[permisiuni.dovada.index(x)]), permissions=perms_mafia)
            await c.set_permissions(ctx.guild.get_role(civil), permissions=perms_civil)
            await c.set_permissions(ctx.guild.get_role(muted), permissions=perms_muted)
            await c.set_permissions(everyone, permissions=perms_everyone)
        ...
        for x in permisiuni.teste1:
            ...
            await c.set_permissions(ctx.guild.get_role(manager), permissions=perms_manager)
            await c.set_permissions(ctx.guild.get_role(permisiuni.lideri[permisiuni.teste1.index(x)]), permissions=perms_lider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.colideri[permisiuni.teste1.index(x)]), permissions=perms_colider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.tester[permisiuni.teste1.index(x)]), permissions=perms_tester)
            await c.set_permissions(ctx.guild.get_role(permisiuni.membru[permisiuni.teste1.index(x)]), permissions=perms_membru)
            await c.set_permissions(ctx.guild.get_role(permisiuni.mafia[permisiuni.teste1.index(x)]), permissions=perms_mafia)
            await c.set_permissions(ctx.guild.get_role(civil), permissions=perms_civil)
            await c.set_permissions(ctx.guild.get_role(muted), permissions=perms_muted)
            await c.set_permissions(everyone, permissions=perms_everyone)
        ...
        for x in permisiuni.teste2:
            ...
            perms_everyone = discord.Permissions(view_channel=True, manage_channels=None, manage_permissions=None, create_instant_invite=None, connect=False, speak=True, priority_speaker=None, mute_members=False, deafen_members=False, move_members=False, video=True, use_voice_activation=None)
            await c.set_permissions(ctx.guild.get_role(manager), permissions=perms_manager)
            await c.set_permissions(ctx.guild.get_role(permisiuni.lideri[permisiuni.teste2.index(x)]), permissions=perms_lider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.colideri[permisiuni.teste2.index(x)]), permissions=perms_colider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.tester[permisiuni.teste2.index(x)]), permissions=perms_tester)
            await c.set_permissions(ctx.guild.get_role(permisiuni.membru[permisiuni.teste2.index(x)]), permissions=perms_membru)
            await c.set_permissions(ctx.guild.get_role(permisiuni.mafia[permisiuni.teste2.index(x)]), permissions=perms_mafia)
            await c.set_permissions(ctx.guild.get_role(civil), permissions=perms_civil)
            await c.set_permissions(ctx.guild.get_role(muted), permissions=perms_muted)
            await c.set_permissions(everyone, permissions=perms_everyone)
        ...
        for x in permisiuni.voce1:
            ...
            await c.set_permissions(ctx.guild.get_role(manager), permissions=perms_manager)
            await c.set_permissions(ctx.guild.get_role(permisiuni.lideri[permisiuni.voce1.index(x)]), permissions=perms_lider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.colideri[permisiuni.voce1.index(x)]), permissions=perms_colider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.tester[permisiuni.voce1.index(x)]), permissions=perms_tester)
            await c.set_permissions(ctx.guild.get_role(permisiuni.membru[permisiuni.voce1.index(x)]), permissions=perms_membru)
            await c.set_permissions(ctx.guild.get_role(permisiuni.mafia[permisiuni.voce1.index(x)]), permissions=perms_mafia)
            await c.set_permissions(ctx.guild.get_role(civil), permissions=perms_civil)
            await c.set_permissions(ctx.guild.get_role(muted), permissions=perms_muted)
            await c.set_permissions(everyone, permissions=perms_everyone)
        ...
        for x in permisiuni.voce2:
            ...
            perms_everyone = discord.Permissions(view_channel=False, manage_channels=False, manage_permissions=False, create_instant_invite=None, connect=False, speak=True, priority_speaker=None, mute_members=False, deafen_members=False, move_members=False, video=True, use_voice_activation=None)
            await c.set_permissions(ctx.guild.get_role(manager), permissions=perms_manager)
            await c.set_permissions(ctx.guild.get_role(permisiuni.lideri[permisiuni.voce2.index(x)]), permissions=perms_lider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.colideri[permisiuni.voce2.index(x)]), permissions=perms_colider)
            await c.set_permissions(ctx.guild.get_role(permisiuni.tester[permisiuni.voce2.index(x)]), permissions=perms_tester)
            await c.set_permissions(ctx.guild.get_role(permisiuni.membru[permisiuni.voce2.index(x)]), permissions=perms_membru)
            await c.set_permissions(ctx.guild.get_role(permisiuni.mafia[permisiuni.voce2.index(x)]), permissions=perms_mafia)
            await c.set_permissions(ctx.guild.get_role(civil), permissions=perms_civil)
            await c.set_permissions(ctx.guild.get_role(muted), permissions=perms_muted)
            await c.set_permissions(everyone, permissions=perms_everyone)
