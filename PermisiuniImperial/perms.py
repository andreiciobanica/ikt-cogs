    ...
    async def permisiuni(self, ctx):
        ...
        for x in permisiuni.politie:
            ...
            if i != 7 and i != 8:
                ...
                for y in permisiuni.politierol:
                    await c.set_permissions(ctx.guild.get_role(y), view_channel=True, manage_channels=False, manage_permissions=False, manage_webhooks=False, create_instant_invite=None, send_messages=None, embed_links=True, attach_files=True, add_reactions=True, use_external_emojis=True, mention_everyone=None, manage_messages=False, read_message_history=True, send_tts_messages=False, use_slash_commands=None)
